...
var preprocess = (testFile => operators.mergeMap(({
  loadFile,
  inMessages,
  outMessages
}) => AsyncObservable(async observer => {
...
var process$1 = (unsubscribe => {
  var _mergeScan;

  return (// @ts-ignore
    _mergeScan = operators.mergeScan(([cache], testFile) => {
      var _ref, _ref2, _ref3, _of, _ref5, _ref6, _merge, _preprocess2, _of2, _merge2, _test2, _of3, _ref11, _mergedResult;
      ...
      , filter(() => hasChanged)(_of) // @ts-ignore
        ...
        return (// @ts-ignore
          ...
          , preprocess(testFile)(_runtimeProvider) // @ts-ignore
          ), takeWhile(({
            preprocessingEnd
      ...
      const _test = ( // @ts-ignore
      _ref5 = (_ref6 = (_merge = rxjs.merge((_preprocess2 = _preprocess // @ts-ignore
      , filter(({
        preprocessingEnd
      }) => preprocessingEnd)(_preprocess2)), ( // @ts-ignore
      ...
      , switchMap((testFile // @ts-ignore
        ...
        , mergeMap((_test // test hasn't changed and is in the cache
          ...
          return _ref7 = (_ref8 = !hashDifference.size && cachedTestFile.tests.find(test => test.description === _test.description && 'executionEnd' in test) || // test has changed or wasn't in the cache
          // @ts-ignore
          runtimeProvider // @ts-ignore
          , test(testFile, _test)(_ref8) // @ts-ignore
          ), takeWhile(({
            executionEnd
      ...
      const _analyze = ( // @ts-ignore
      _merge2 = rxjs.merge((_test2 = _test // @ts-ignore
      , filter(({
        preprocessEnd
      }) => preprocessEnd)(_test2)), ( // @ts-ignore
      ...
      const mergedResult = rxjs.merge(_preprocess, _test, _analyze);
      return (// @ts-ignore
...
var Tester = (options => rxjs.Observable.create(observer => {
  ...
  // @ts-ignore
  ), operators.takeUntil(unsubscribe)(_ref7)); // @ts-ignore

  const tests = process$1({
    bundle,
    runtimeProvider
  }); // @ts-ignore
